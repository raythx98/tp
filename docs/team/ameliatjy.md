...
* **Enhancements to existing features**:
  * Preliminary adaptation from AB3 to cater for Person and Job. (Pull requests
  [\#35](https://github.com/AY2021S1-CS2103T-T17-3/tp/pull/35) and
...
* **Documentation**:
  ...
  * User Guide:
    ...
    * Wrote documentation for the features `find can` and `find job`. (Pull request
    [\#155](https://github.com/AY2021S1-CS2103T-T17-3/tp/pull/155))
